...
export const APP_ROUTES = [
  { path: "/dashboard", label: "Command Centre", icon: "⚡", description: "Central tactical HUD, persistent Pomodoro & 3D Universe." },
  { path: "/syllabus", label: "Syllabus Matrix", icon: "📚", description: "Neural mindmap syllabus tracker with GS-1 to GS-4 subtopic tracking." },
  { path: "/study-plan", label: "Study Plan & Sanctuary", icon: "📅", description: "Dynamic daily schedule, Pomodoro sprints & active study network." },
  { path: "/pyqs", label: "Prelims PYQ Arena", icon: "📝", description: "10 Interactive 3D Visual Labs, Mnemonic Vault & PYQ testing." },
